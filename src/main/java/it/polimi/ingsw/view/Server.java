...
//    private Map<Integer, Connection> waitingConnection = new HashMap<>();
...
//        waitingConnection.put(age, c);
//        List<Integer> keys = new ArrayList<>(waitingConnection.keySet());
//        if(waitingConnection.size() == 1){
//            waitingConnection.get(keys.get(0)).send("Choose number of players");
//            numOfPlayers = Integer.parseInt(waitingConnection.get(keys.get(0)).receive());
//        }
//        else if(waitingConnection.size() == 2 && numOfPlayers == 2){
...
//        }
//        else if(waitingConnection.size() == 3 && numOfPlayers == 3){
//            // Same with 3 players
//        }
//    }
//
